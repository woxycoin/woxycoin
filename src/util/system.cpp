...
const char * const BITCOIN_CONF_FILENAME = "woxycoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Woxycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Woxycoin";
#else
    // Unix-like
    return pathRet / ".woxycoin";
#endif
#endif
}
