...
{
    const char* pszTimestamp = "Woxycoin Genesis 29/Jan/2026 - A New Beginning";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x6ba20f9f8a32a60f6479eeac98b18784d9fd6eefe48de55aa25be3804c2a93fc");
        ...
        genesis = CreateGenesisBlock(1769834120, 1958965, 0x1e0ffff0, 1, 50 * COIN);
        ...
        checkpointData = {
            {
                {0, uint256S("0x6ba20f9f8a32a60f6479eeac98b18784d9fd6eefe48de55aa25be3804c2a93fc")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.BIP16Height = 0;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x2196b8c774d819a68894c905f8bd09f8f09b74fb9c789c1aad3832ef7fa0eaa0");
        consensus.BIP65Height = 0;
        consensus.BIP66Height = 0;
        consensus.CSVHeight = 0;
        consensus.SegwitHeight = 0;
        ...
        genesis = CreateGenesisBlock(1769644801, 294119, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2196b8c774d819a68894c905f8bd09f8f09b74fb9c789c1aad3832ef7fa0eaa0"));
        assert(genesis.hashMerkleRoot == uint256S("0x076110288ba77192bd351832c4549c9bf52dd090d8fc67ad838fa1e2e76f2dca"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x2196b8c774d819a68894c905f8bd09f8f09b74fb9c789c1aad3832ef7fa0eaa0")}
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1769644802, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbc2186fffdb1412eb3296d6aa6b32bab3c7d55c0c5a44e42f1ca8061ee0c1252"));
        assert(genesis.hashMerkleRoot == uint256S("0x076110288ba77192bd351832c4549c9bf52dd090d8fc67ad838fa1e2e76f2dca"));
        ...
        checkpointData = {
            {
                {0, uint256S("0xbc2186fffdb1412eb3296d6aa6b32bab3c7d55c0c5a44e42f1ca8061ee0c1252")},
            }
        };
